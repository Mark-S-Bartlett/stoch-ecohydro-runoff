...
zarr_store_path=f'/dbfs/mnt/{aws_bucket_name}/data/hydrology/ET_MODIS/MODIS_8_Day_PET_500m_{project}_2000-01-01_to_2024-12-31.zarr'
...
# MAGIC %md
# MAGIC Compare to the just a straight averaging without Gaussian weights. We do not use this version.
...
#Look at the resolut for 1 year
n1=0
...
smoothed_rolling_aligned, ds_DI_aligned = xr.align(lambda_alpha_smoothed_rolling, ds_DI, join="inner")
